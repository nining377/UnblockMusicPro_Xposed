...
public class BlackHook {
    public BlackHook(Context context, int versionCode) {
        if (versionCode < 138) {
            ...
            findAndHookMethod(findClass("com.netease.cloudmusic.meta.Profile", context.getClassLoader()),
                    "getVipProExpireTime", XC_MethodReplacement.returnConstant(System.currentTimeMillis() + 100000));

            //音乐包
            findAndHookMethod(findClass("com.netease.cloudmusic.meta.Profile", context.getClassLoader()),
                    "isVip", XC_MethodReplacement.returnConstant(true));
            findAndHookMethod(findClass("com.netease.cloudmusic.meta.Profile", context.getClassLoader()),
                    "getExpireTime", XC_MethodReplacement.returnConstant(System.currentTimeMillis() + 100000));
        } else {
            //黑胶
            ...
            findAndHookMethod(findClass("com.netease.cloudmusic.meta.virtual.UserPrivilege", context.getClassLoader()),
                    "getBlackVipExpireTime", XC_MethodReplacement.returnConstant(System.currentTimeMillis() + 100000));

            //音乐包
            findAndHookMethod(findClass("com.netease.cloudmusic.meta.virtual.UserPrivilege", context.getClassLoader()),
                    "isWhateverMusicPackage", XC_MethodReplacement.returnConstant(true));
            findAndHookMethod(findClass("com.netease.cloudmusic.meta.virtual.UserPrivilege", context.getClassLoader()),
                    "getMusicPackageExpireTime", XC_MethodReplacement.returnConstant(System.currentTimeMillis() + 100000));
